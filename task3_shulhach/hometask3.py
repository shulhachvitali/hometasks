...
def log ():
    ...
    flog.write(str(b.__round__(2))+"mb availible memory"+'\n')
...
def log2():
    ...
    snapshot = {
        ...
        'mb availible memory': (psutil.virtual_memory().available/(1024*1024)).__round__(2),
        ...
        'mb recieved via all interfaces': (psutil.net_io_counters(pernic=False)[1]/(1024*1024)).__round__(2)
            }
